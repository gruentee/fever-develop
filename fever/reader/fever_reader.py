...
class FEVERDatasetReader(DatasetReader):
    ...
    @overrides
    def text_to_instance(self, claim_id: int, evidence_group: int, evidence: str, claim: str,
    ...
    def generate_instances(self,
        ...
        return [self.text_to_instance(claim_id, item['evidence_group'], item['evidence'], item['claim'], label) for item
                in generated]
    ...
    def _read(self, file_path: str):
        with open(file_path, "r") as f:
            for line in f:
                ...
                evidence: List[List[Tuple[int, str, int]]] = [[(item[1], item[2], item[3]) for item in group] for group
                                                              in evidence]
